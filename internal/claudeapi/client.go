...
// Contrairement à internal/repository/internal/storage (Supabase) et
// internal/gmailapi (Google), Anthropic fournit un SDK Go officiel —
// inutile de refaire du REST à la main ici.
package claudeapi
