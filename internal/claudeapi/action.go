...
// revalidée ici (cf. email.RouterEmail, qui fait cette vérification avant
// de faire confiance à la réponse) —, avec un indice de confiance et une
// explication.
...
// DecideAction demande à Claude, à partir de la liste des actions
// possibles (table action) et du contexte de routage d'un e-mail dont la
// copropriété a déjà été identifiée (personne, rôle, copropriété,
// lots/contrats éventuels), quelle action décrit le mieux le contenu de
// cet e-mail.
