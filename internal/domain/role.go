...
const (
	...
	RoleCoproprietaire  Role = "coproprietaire"   // Personne.EstCoproprietaire — jamais la copropriété elle-même : cf. Copropriete.EstSyndic (syndic) et gestion locative de son lot, deux fonctions commerciales indépendantes du cabinet
